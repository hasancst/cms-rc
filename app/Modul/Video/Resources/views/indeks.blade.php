            ...
            <tr>
                ...
                <td>
                    <div style="display: flex; gap: 10px;">
                        ...
                        <form action="/admin/video/hapus/{{ $v->id }}" method="POST" style="display:inline;" onsubmit="return confirm('Hapus video ini?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" style="background:none;border:none;cursor:pointer;color:#ef4444;padding:0;"><i class="fas fa-trash-alt"></i></button>
                        </form>
                    </div>
                </td>
            </tr>
