                        ...
                        <tr style="border-bottom: 1px solid #f8f9fa;">
                            ...
                            <td style="padding: 12px;">
                                <div style="display: flex; gap: 8px;">
                                    <button class="btn btn-sm" onclick="editCat({{ $c->id }}, '{{ $c->nama }}', '{{ $c->ikon }}', '{{ $c->urutan }}', '{{ $c->deskripsi }}')" style="padding: 5px 10px; font-size: 12px;">Edit</button>
...
<script>
    function editCat(id, nama, ikon, urutan, desk) {
